...
<html>
<head>
    <title>Booking Campaign Instructions</title>
    <style>
        body {
...
<body>
    <header>
        ...
        <h1>Booking Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for Booking Campaign</h2>
        <ol>
            ...
            <li>Press the Windows key + R to open the Run dialog. Type "temp" and press Enter.</li>
            <li>Go to "Properties," then "Security."</li>
            <li>Ensure that "Users" has the necessary permissions. If not, enable the required options.</li>
        ...
        <div class="programs">
    <h2>Booking Programs</h2>
    <img src="images/probooking.jpg" alt="Booking Programs" style="max-width: 100%;">
</div>
