...
<html>
<head>
    <title>GNC Campaign Instructions</title>
    <style>
        body {
...
<body>
    <header>
        <img src="images/gnc.png" alt="GNC Logo">
        <h1>GNC Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for GNC Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>GNC Programs</h2>
            <img src="images/gncpro.jpg" alt="GNC Programs" style="max-width: 50%;">
        </div>
    </div>
</body>
</html>
