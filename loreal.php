...
<html>
<head>
    <title>L'Oreal Campaign Instructions</title>
    <style>
        body {
...
<body>
    <header>
        <img src="images/loreal-logo.jpg" alt="L'Oreal Logo">
        <h1>L'Oreal Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for L'Oreal Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>L'Oreal Programs</h2>
            <img src="images/lorealpro.jpg" alt="L'Oreal Programs" style="max-width: 100%;">
        </div>
    </div>
</body>
</html>
