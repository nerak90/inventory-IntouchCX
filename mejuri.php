...
<html>
<head>
    <title>Mejuri Campaign Instructions</title>
    <style>
        body {
        ...
        header {
            background-color: #E9967A; /* Salmón marrón */
            text-align: center;
            padding: 20px 0;
        }
...
<body>
    <header>
        <img src="images/mejuri.png" alt="Mejuri Logo">
        <h1>Mejuri Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for Mejuri Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>Mejuri Programs</h2>
    <img src="images/mejuripro.jpg" alt="Mejuri Programs" style="max-width: 500%;">
