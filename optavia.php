...
<html>
<head>
    <title>Optavia Campaign Instructions</title>
    <style>
        body {
        ...
        header {
            background-color: #ADD8E6; /* Azul celeste más claro */
            text-align: center;
            padding: 20px 0;
        ...
        h2 {
            font-size: 1.5rem;
            margin: 10px 0;
            color: #ADD8E6; /* Azul celeste más claro */
        }
...
<body>
    <header>
        <img src="images/optavia.jpg" alt="Optavia Logo">
        <h1>Optavia Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for Optavia Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>Optavia Programs</h2>
            <img src="images/optaviapro.jpg" alt="Optavia Programs" style="max-width: 100%;">
        </div>
    </div>
</body>
</html>
