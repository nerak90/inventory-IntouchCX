...
<html>
<head>
    <title>Red Robin Campaign Instructions</title>
    <style>
        body {
...
<body>
    <header>
        <img src="images/redR.png" alt="Red Robin Logo">
        <h1>Red Robin Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for Red Robin Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>Red Robin Programs</h2>
            <img src="images/redpro.jpg" alt="Red Robin Programs" style="max-width: 100%;">
        </div>
    </div>
</body>
</html>
