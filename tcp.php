...
<html>
<head>
    <title>TCP Campaign Instructions</title>
    <style>
        body {
        ...
        .action-button {
            padding: 10px 20px;
            background-color: #FFFF00; /* Color blanco */
            color: #000;
            border: none;
            border-radius: 5px;
            cursor: pointer;
...
<body>
    <header>
        <img src="images/tcpl.png" alt="TCP Logo">
        <h1>TCP Campaign Instructions</h1>
    ...
    <div class ="instructions">
        <h2>Instructions for TCP Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>TCP Programs</h2>
            <img src="images/tcppro.jpg" alt="TCP Programs" style="max-width: 100%;">
        </div>
    </div>
</body>
</html>
