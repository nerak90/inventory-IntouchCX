...
<html>
<head>
    <title>Vroom Campaign Instructions</title>
    <style>
        body {
        ...
        header {
            background-color:#FAEBD7; /* Color hueso */
            text-align: center;
            padding: 20px 0;
        }
...
<body>
    <header>
        <img src="images/vroom.png" alt="Vroom Logo">
        <h1>Vroom Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for Vroom Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>Vroom Programs</h2>
            <img src="images/Vroompro.jpg" alt="Vroom Programs" style="max-width: 100%;">
        </div>
    </div>
</body>
</html>
