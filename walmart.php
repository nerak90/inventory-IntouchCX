...
<html>
<head>
    <title>Walmart Campaign Instructions</title>
    <style>
        body {
...
<body>
    <header>
        ...
        <h1>Walmart Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for Walmart Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>Walmart Programs</h2>
            <img src="images/walmartpro.jpeg" alt="Walmart Programs" style="max-width: 100%;">
        </div>
    </div>
</body>
</html>
