...
<html>
<head>
    <title>Weber Campaign Instructions</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            background-color: #E9967A; /* Color hueso */
        ...
        .action-button {
            padding: 10px 20px;
            background-color: #000; /* Color blanco */
            color: #fff;
            border: none;
            border-radius: 5px;
            cursor: pointer;
...
<body>
    <header>
        <img src="images/weberlogo.png" alt="Weber Logo">
        <h1>Weber Campaign Instructions</h1>
    ...
    <div class="instructions">
        <h2>Instructions for Weber Campaign</h2>
        <ol>
        ...
        <div class="programs">
            <h2>Weber Programs</h2>
            <img src="images/weberpro.jpg" alt="Weber Programs" style="max-width: 100%;">
        </div>
    </div>
</body>
</html>
